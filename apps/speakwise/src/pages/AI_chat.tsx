      ...
      <>
        ...
        <style>{`
          ...
          *{box-sizing:border-box}
          ...
          .btn-secondary{
            height:80px;
            background: linear-gradient(90deg,#365b8e,#6f8fb8);
            color:white;
            box-shadow: 0 12px 30px rgba(54,91,142,0.18);
            font-size:18px;
          }
    ...
    return (
      <>
        <style>{`
          ...
          .chat-window{background:#f6f9fd;border-radius:10px;padding:12px;flex:1;min-height:0;overflow:auto;margin-bottom:8px;border:1px solid #d9e4f2;padding-bottom:88px}
                  ...
                  <div style={{
                    ...
                    <button
                      ...
                      style={{
                        ...
                        background: "#edf4ff",
                        color: "#1f4f91",
                        border: "2px solid #7da2d7",
                        fontWeight: "bold",
                        cursor: "pointer",
                        fontSize: "14px",
                        transition: "background 0.2s ease, transform 0.15s ease"
                      }}
                      onMouseEnter={(e) => (e.currentTarget.style.background = "#dfeaf9")}
                      onMouseLeave={(e) => (e.currentTarget.style.background = "#edf4ff")}
