...
export const OPENING_QUESTIONS: Record<string, Record<CEFRLevel, Record<PracticeMode, string[]>>> = {
  ...
  "Law & Politics": {
    A1: {
      speaking: [
        "What is one rule you like or think about often?",
        "What do you like about a school rule?",
        "Do you use a traffic rule in your daily life?",
        "What is one rule that feels new or interesting to you?",
        "Where do you usually use a leader?",
        "Who helps you with rule?",
        "What rule is easy for you?",
        "What rule is difficult for you?",
        "When do you usually think about rule?",
        "Which is better for you: voting or a public speech?"
      ],
      writing: [
        "What rule is important or interesting to you?",
        "How do you use, do, or experience a school rule in daily life?",
        "What do you like about a traffic rule?",
        "Where do you usually see or use a leader?",
        "Who do you talk to about rule?",
        "What is one good thing about voting?",
        "What is one problem with a public speech?",
        "What rule would you like to try?",
        "What rule do people around you often use?",
        "Which do you prefer: a community meeting or news?"
      ],
    },
    A2: {
      speaking: [
        "Why is a school rule useful for you?",
        "How often do you use, do, or think about a traffic rule?",
        "What should beginners know about rule?",
        "Which is more useful: a leader or voting? Why?",
        "What is a good way to enjoy rule?",
        "How can a public speech help people?",
        "What problem can happen with a community meeting?",
        "What rule would you recommend to a friend?",
        "How is rule different now from when you were younger?",
        "What would you like to learn about rule?"
      ],
      writing: [
        "Why do many people like a school rule?",
        "How can a traffic rule make daily life easier?",
        "What are two good points about a leader?",
        "What is one bad point about voting?",
        "Which rule would you choose for a busy day?",
        "How can people use a public speech in a better way?",
        "What advice would you give to someone trying a community meeting for the first time?",
        "What rule is popular in your country?",
        "How does news help people communicate or work together?",
        "What small change related to rule could improve your day?"
      ],
    },
    B1: {
      speaking: [
        "How has rule changed people's daily lives?",
        "Why do some people enjoy a school rule while others do not?",
        "What is one problem in school or community that rule can improve?",
        "How can people make better choices about a traffic rule?",
        "What are the good and bad sides of a leader?",
        "Why is free speech important for ordinary people?",
        "What should young people learn about rule?",
        "How can families or schools support better habits around rule?",
        "What mistake do people often make with voting?",
        "How might rule be different ten years from now?"
      ],
      writing: [
        "How does rule affect students or young people?",
        "Why might a school rule be helpful in some situations but not in others?",
        "What is one realistic solution to a problem related to rule?",
        "How can people balance convenience and responsibility when using or doing a traffic rule?",
        "What are two reasons why free speech matters today?",
        "How can communities encourage better decisions about rule?",
        "What should schools teach about a leader?",
        "How does money, time, or access change people's choices about rule?",
        "What example shows the positive side of voting?",
        "What example shows the negative side of a public speech?"
      ],
    },
    B2: {
      speaking: [
        "Which matters more in rule: convenience or responsibility?",
        "Should schools or governments do more about free speech? Why?",
        "How can people enjoy the benefits of a school rule while reducing the risks?",
        "What is one strong argument for and against stricter rules on misinformation?",
        "How does voting rights affect ordinary families or students?",
        "Is personal choice enough to solve problems related to rule?",
        "How should leaders explain difficult decisions about public safety?",
        "What trade-off appears when people choose between cost and quality in rule?",
        "How can technology or social change improve rule?",
        "What kind of evidence would change your opinion about rule of law?"
      ],
      writing: [
        "How should society balance individual freedom and public responsibility in rule?",
        "Which policy would be most effective for addressing free speech, and why?",
        "How do short-term benefits and long-term risks conflict in decisions about a school rule?",
        "What are the strongest arguments on both sides of the debate about misinformation?",
        "How can institutions build trust when dealing with voting rights?",
        "Should companies, governments, or individuals take the main responsibility for problems related to rule?",
        "How does inequality influence people's choices or opportunities in rule?",
        "What would a fair compromise look like in a disagreement about public safety?",
        "How can education change public behavior related to rule of law?",
        "What unintended consequence could come from trying to improve rule?"
      ],
    },
    C1: {
      speaking: [
        "How should society balance progress and caution in rule?",
        "What responsibility do institutions have when decisions about free speech affect vulnerable people?",
        "How can policymakers respond to misinformation without creating new unfairness?",
        "What should count as success when improving rule?",
        "How can experts communicate uncertainty about voting rights to the public?",
        "When should individual freedom be limited for the sake of public safety?",
        "How can international cooperation help solve problems related to rule of law?",
        "What role should public trust play in decisions about rule?",
        "How can society avoid focusing only on efficiency in rule?",
        "What kind of leadership is needed when values conflict in rule?"
      ],
      writing: [
        "How should governments design policies that encourage innovation while protecting people from risks in rule?",
        "What principles should guide decisions when free speech conflicts with economic or personal interests?",
        "How can society evaluate whether reforms in rule are actually fair?",
        "What is the most persuasive case for prioritizing misinformation over short-term convenience?",
        "How should experts, citizens, and policymakers share responsibility for voting rights?",
        "What limits should be placed on powerful organizations involved in rule?",
        "How can public systems prepare for long-term challenges connected to public safety?",
        "What trade-off in rule is often ignored in public debate?",
        "How can communities protect minority interests when making decisions about rule of law?",
        "What lesson from history or current society helps explain a challenge in rule?"
      ],
    },
    C2: {
      speaking: [
        "What moral trade-offs should guide difficult decisions in rule?",
        "How should society act when evidence about free speech is incomplete but the stakes are high?",
        "What does fairness mean when different groups experience the costs and benefits of rule differently?",
        "How can long-term responsibility be taken seriously in debates about misinformation?",
        "When does compromise in rule become necessary, and when does it become harmful?",
        "How should societies handle conflicts between expert judgment and public opinion about voting rights?",
        "What hidden assumptions shape public debates about rule?",
        "How can decision-makers avoid solving one problem while deepening another in public safety?",
        "What responsibility do powerful countries or organizations have in shaping rule?",
        "How should human dignity influence the future of rule?"
      ],
      writing: [
        "What ethical framework best addresses conflicts between progress, fairness, and responsibility in rule?",
        "How should societies make decisions about free speech when no option is fully fair?",
        "What deeper value conflict lies beneath debates about misinformation?",
        "How can institutions remain legitimate when they must make unpopular decisions about rule?",
        "What responsibilities do present generations have when their choices in rule affect people who cannot participate in today's debate?",
        "How should global inequality shape the way we think about voting rights?",
        "When does neutrality become impossible in decisions about rule?",
        "How can society distinguish responsible innovation from reckless experimentation in public safety?",
        "What would a humane future for rule require beyond technical or economic success?",
        "How should conflicting ideas of justice be handled in a debate about rule of law?"
      ],
    },
  },
  "Engineering": {
